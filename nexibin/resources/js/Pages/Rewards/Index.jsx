          ...
          <tbody className="divide-y divide-slate-50">
            {redemptions.map((r) => (
              <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="py-3 pr-4 font-semibold text-slate-700">{r.reward?.name ?? "—"}</td>
                ...
                <td className="py-3 pl-4 text-right text-xs text-slate-400">{timeAgo(r.created_at)}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          {activeSection === "rewards" ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 fade-up stagger-1">
              ...
              {/* Records */}
              <RedemptionHistory redemptions={redemptionData} />
